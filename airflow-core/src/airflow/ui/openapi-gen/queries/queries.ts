...
* @throws ApiError
*/
export const useBackfillServiceListBackfillsUi = <TData = Common.BackfillServiceListBackfillsUiDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ active, dagId, fromDateGt, fromDateGte, fromDateLt, fromDateLte, limit, offset, orderBy, toDateGt, toDateGte, toDateLt, toDateLte }: {
  active?: boolean;
  dagId?: string;
  fromDateGt?: string;
  fromDateGte?: string;
