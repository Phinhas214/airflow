...
* @throws ApiError
*/
export const ensureUseBackfillServiceListBackfillsUiData = (queryClient: QueryClient, { active, dagId, fromDateGt, fromDateGte, fromDateLt, fromDateLte, limit, offset, orderBy, toDateGt, toDateGte, toDateLt, toDateLte }: {
  active?: boolean;
  dagId?: string;
  fromDateGt?: string;
  fromDateGte?: string;
