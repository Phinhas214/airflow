...
* @throws ApiError
*/
export const prefetchUseBackfillServiceListBackfills = (queryClient: QueryClient, { dagId, fromDateGt, fromDateGte, fromDateLt, fromDateLte, limit, offset, orderBy }: {
  dagId: string;
  fromDateGt?: string;
  fromDateGte?: string;
  fromDateLt?: string;
  ...
  offset?: number;
  orderBy?: string[];
}) => queryClient.prefetchQuery({ queryKey: Common.UseBackfillServiceListBackfillsKeyFn({ dagId, fromDateGt, fromDateGte, fromDateLt, fromDateLte, limit, offset, orderBy }), queryFn: () => BackfillService.listBackfills({ dagId, fromDateGt, fromDateGte, fromDateLt, fromDateLte, limit, offset, orderBy }) });
/**
* Get Backfill
* @param data The data for the request.
